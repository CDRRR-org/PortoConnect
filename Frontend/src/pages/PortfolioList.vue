...
const deletePortfolio = async (id) => {
  ...
  try {
    ...
    // gunakan err untuk debug; berikan pesan user-friendly
    console.error('deletePortfolio error:', err)
    alert('Gagal menghapus portofolio. Silakan coba lagi.')
  }
}
...
const handleLogout = async () => {
  try {
    ...
    // catat error supaya linter tidak protes dan kita bisa debug
